...
<html lang="en">
  <head>
    <title>Sin-Costum - Sewa Kostum Kekinian</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <nav id="colorlib-main-nav" role="navigation">
      ...
      <div class="js-fullheight colorlib-table">
        <div class="img" style="background-image: url(<?=base_url()?>assets/user/images/image_4.jpg);"></div>
    ...
    <div id="colorlib-page">
      <header>
      	<div class="container">
			...
			<section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(<?=base_url()?>assets/user/images/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;">
					...
					<div class="row">
						<div class="col-md-6 col-lg-3">
							<div class="model-entry">
								<div class="model-img" style="background-image: url(<?=base_url()?>assets/user/images/image_1.jpg);">
						...
						<div class="col-md-6 col-lg-3">
							<div class="model-entry">
								<div class="model-img" style="background-image: url(<?=base_url()?>assets/user/images/image_2.jpg);">
			    				<div class="name text-center">
						...
						<div class="col-md-6 col-lg-3">
							<div class="model-entry">
								<div class="model-img" style="background-image: url(<?=base_url()?>assets/user/images/image_3.jpg);">
			    				<div class="name text-center">
						...
						<div class="col-md-6 col-lg-3">
							<div class="model-entry">
								<div class="model-img" style="background-image: url(<?=base_url()?>assets/user/images/image_4.jpg);">
			    				<div class="name text-center">
	      ...
	      <div class="container">
	        ...
	        <div class="row d-flex">
	          <div class="col-md-4 d-flex ftco-animate">
	              ...
	              <a href="blog-single.html" class="block-20" style="background-image: url('<?=base_url()?>assets/user/images/image_1.jpg');">
	              </a>
	          ...
	          <div class="col-md-4 d-flex ftco-animate">
	          	<div class="blog-entry bg-dark align-self-stretch">
	              <a href="blog-single.html" class="block-20" style="background-image: url('<?=base_url()?>assets/user/images/image_2.jpg');">
	              </a>
	              <div class="text p-4 d-block">
	              	<div class="meta mb-3">
	                  <div><a href="#">May 17, 2019</a></div>
	          ...
	          <div class="col-md-4 d-flex ftco-animate">
	          	<div class="blog-entry bg-dark align-self-stretch">
	              <a href="blog-single.html" class="block-20" style="background-image: url('<?=base_url()?>assets/user/images/image_3.jpg');">
	              </a>
	              <div class="text p-4 d-block">
	              	<div class="meta mb-3">
	                  <div><a href="#">May 17, 2019</a></div>
	    ...
	    <section class="ftco-section testimony-section img" style="background-image: url(<?=base_url()?>assets/user/images/bg_2.jpg);">
	    	<div class="overlay"></div>
	      <div class="container">
	          ...
	          <div class="col-md-4">
	            <div class="ftco-footer-widget mb-4">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(<?=base_url()?>assets/user/images/image_1.jpg);"></a>
	                <div class="text">
	              ...
	              <div class="block-21 mb-4 d-flex">
	                <a class="blog-img mr-4" style="background-image: url(<?=base_url()?>assets/user/images/image_2.jpg);"></a>
	                <div class="text">
	                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
	                  <div class="meta">
	                    <div><a href="#"><span class="icon-calendar"></span> July 12, 2018</a></div>
    ...
    <script src="<?=base_url()?>assets/user/js/jquery.mb.YTPlayer.min.js"></script>
